...
app.get('/storj', function(req, res) {
    console.log('storj');

    const storj = new libstorj.Environment({
        bridgeUrl: 'https://api.storj.io',
        bridgeUser: 'eddy.guo@gmail.com',
        bridgePass: 'vtow7h93p8cy',
        encryptionKey: 'anana abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about',
        logLevel: 0
    });
